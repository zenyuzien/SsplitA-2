      ...
      for (long j = i - 1; j >= 0; j--) {
        ...
        if (((tmp.d[0].first == db[i].d[0].first) &&
          ...
          ((tmp.d[4].first == db[i].d[4].first) &&
            (tmp.d[4].second == db[i].d[4].second))) { // tmp is subset of 1st rule 
        ...
        if (((tmp.d[0].first == db[j].d[0].first) &&
          ...
          ((tmp.d[4].first == db[j].d[4].first) &&
            (tmp.d[4].second == db[j].d[4].second))) { // tmp is subset of 2nd rule 
          ...
          junk.insert(db[j].lit);; //append tmp lits to 2nd rule
          continue;
        }
